module register_block (
    ...
    output logic [31:0] out_global_ctrl,
    output logic [31:0] out_int_status_wlc,
    ...
    logic [31:0] reg_int_status_wlc;
    logic [31:0] reg_int_clr;

    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            reg_global_ctrl <= 32'h1;
            reg_int_status_wlc <= 32'h0;
            reg_int_clr <= 32'h5;
        end else if (wen) begin
            unique case (addr)
                16'h0000: reg_global_ctrl <= wdata[31:0];
                16'h0004: reg_int_status_wlc <= wdata[31:0];
